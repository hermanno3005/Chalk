...
struct LogSheetModelTests {
    ...
    func beatsTheRepMax() throws {
        ...
        #expect(model.verdict == "Beats your 5-rep best by \(kg(2.5)) kg")
    }
    ...
    func belowTheRepMax() throws {
        ...
        #expect(model.verdict == "Your 5-rep best is \(kg(55)) kg")
    }
    ...
    func firstEntryAtThisRepCount() throws {
        ...
        #expect(model.verdict == "First entry at 8 reps")
    }
    ...
    func verdictHoldsBeyondTheAxis() throws {
        ...
        #expect(model.verdict == "Matches your 15-rep best")
    }
